    ...
    <div className="manage-deliveries-container">
      ...
      <div className="status-cards-row">
        ...
        <div className="status-tab-card bg-green border-green">
          ...
          <span className="status-tab-value text-green">1</span>
        </div>
      </div>
